				...
				<TR>
					...
					<TD
						...
						<DIV>
							<table>
						       <tr > 
						          <td align="right"><a href="rewards_find.action?type=1">奖励</a></td>
						          <td align="left"><a href="rewards_find.action?type=0">惩罚</a></td>
						       </tr>
						    </table>
							<TABLE class=gridView id=ctl00_ContentPlaceHolder2_GridView1
								...
								惩戒
													...
													<td class=gridViewItem><a
														...
														href="rewards_delete.action?uids=${cjs.id}">删除</a>
													</td>
												</tr>
											</c:forEach>
										</c:otherwise>
							...
							<table align="right">
								<tr>
									<td><div align="right">
											...
											<a
												href="rewards_list.action?page=1&pageSize=${pageModel.pageSize}">首页</a>
											<a
												href="rewards_list.action?page=${pageModel.page == 1 ? pageModel.page : (pageModel.page - 1)}&pageSize=${pageModel.pageSize}">上一页</a>
											<a
												href="rewards_list.action?page=${pageModel.page == pageModel.pageCount ? pageModel.pageCount : (pageModel.page + 1) }&pageSize=${pageModel.pageSize}">下一页</a>
											<a
												href="rewards_list.action?page=${pageModel.pageCount }&pageSize=${pageModel.pageSize}">尾页</a>
										</div>
									</td>
								</tr>
							</table>
