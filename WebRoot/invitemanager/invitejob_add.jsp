       ...
       PADDING-TOP: 10px; BACKGROUND-REPEAT: repeat-x; HEIGHT: 47px; TEXT-ALIGN: center; 0px: ">招聘管理
			...
			<tr>
				...
				<TD
					...
					<form action="inviteJob_add.action" method="post">
						<table class=gridView id=ctl00_ContentPlaceHolder2_GridView1
							...
							<tr>
								<td colspan="4"><table width="100%" border="0"
										...
										<tr class=gridViewHeader scope=col>
											...
											<td width="98%" valign="middle" class="STYLE1">添加应聘人信息</td>
										</tr>
									</table>
								</td>
							</tr>
							...
							<tr>
								...
								<td class=gridViewItem>
									<select name="job" value="${inviteJobDto.job}">
							...
							<tr>
								...
								<td class=gridViewItem><fmt:formatDate
									...
									value="${createTime}" /><br /></td>
							</tr>
							<tr>
								<td><input type="hidden" name="isstock" value="0" />
								</td>
							</tr>
							<tr>
								<th class=gridViewHeader scope=col>个人简介:</th>
								<td colspan="3" class=gridViewItem><textarea rows="10"
										cols="56" name="content" ></textarea></td>
							</tr>
							<tr>
