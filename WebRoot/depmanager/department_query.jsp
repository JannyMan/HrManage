									...
									<tr>
										<td colspan="5"><table width="100%" border="0"
												...
												<tr class=gridViewHeader scope=col>
													...
													<td width="68%" valign="middle" class="STYLE1">部门列表</td>
													<td align="right" width="30%" valign="middle"
														class="STYLE1"><a href="department_add.action">添加部门</a>
													</td>
												</tr>
											</table>
										</td>
										...
										<c:otherwise>
											<c:forEach items="${departments}" var="departments">
												<tr align="center" bgcolor="#FFFFFF">
													<td class=gridViewItem>${departments.id}</td>
													<td class=gridViewItem>${departments.name}</td>
													<td class=gridViewItem>${departments.createTime}</td>
													<td class=gridViewItem>${departments.bz}</td>
													<td class=gridViewItem><a
														href="department_show.action?uids=${departments.id}">详细查看</a>
														<a href="department_delete.action?uids=${departments.id}">删除</a>
													</td>
												</tr>
											</c:forEach>
										</c:otherwise>
							...
							<table align="right">
								<tr>
									<td><div align="right">
											...
											<a
												href="department_list.action?page=1&pageSize=${pageModel.pageSize}">首页</a>
											<a
												href="department_list.action?page=${pageModel.page == 1 ? pageModel.page : (pageModel.page - 1)}&pageSize=${pageModel.pageSize}">上一页</a>
											<a
												href="department_list.action?page=${pageModel.page == pageModel.pageCount ? pageModel.pageCount : (pageModel.page + 1) }&pageSize=${pageModel.pageSize}">下一页</a>
											<a
												href="department_list.action?page=${pageModel.pageCount }&pageSize=${pageModel.pageSize}">尾页</a>
										</div>
									</td>
								</tr>
							</table>
