				...
				<TD
					...
					vAlign=top align=middle>
						<table class=gridView id=ctl00_ContentPlaceHolder2_GridView1
							...
							<tr>
								<td colspan="2"><table width="100%" border="0"
										...
										<tr class=gridViewHeader scope=col>
											...
											<td width="98%" valign="middle" class="STYLE1">部门详情</td>
										</tr>
									</table></td>
							</tr>
							<tr>
								<td><input type="hidden" name="id" value="${department.id}" />
								</td>
							</tr>
							<tr>
							...
							<tr>
								<td colspan="2" class=gridViewItem><input type="button" value="返回"
